<?php
	...
	define( 'ECKO_THEME_VERSION', '1.0.3' );
	...
	function cedar_save_option_meta( $post_id, $post ) {
		...
		if ( $is_autosave || $is_revision && !$cedar_cover_enabled_meta && !$cedar_subtitle_meta && !$cedar_cover_height_meta  && !$cedar_cover_color_meta && !$cedar_title_center_meta && !$cedar_postlist_image_meta) {
			return;
		}
				...
				<div class="contents">
					...
					<div class="main">
						<div class="commentinfo">
							<section class="meta">
								<div class="info"><?php esc_html_e('Posted', ECKO_THEME_ID) ; ?> <span class="date"><?php esc_html_e('on', ECKO_THEME_ID) ; ?> <i class="fa fa-clock-o"></i> <time datetime="<?php comment_date('Y-m-d'); ?>"><?php comment_date('jS F Y '); ?></time></span></div>
