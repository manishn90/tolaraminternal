...
?>
	...
	<section class="cover" style="background-color:#<?php echo esc_attr($cedar_cover_color_meta); ?>; height:<?php echo esc_attr($cedar_cover_height_meta); ?>vh;" data-height="<?php echo esc_attr($cedar_cover_height_meta); ?>">
		...
		<section class="postitem posttitle center wrapper <?php echo $class; ?>" style="color:white;">
			<ul class="meta">
				<?php 
