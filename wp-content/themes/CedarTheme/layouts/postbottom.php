...
?>
	...
	<section class="postbottom wrapper">
		...
		<div class="shareoptions">
			<a href="#" class="permalink"><?php esc_html_e('Permalink', ECKO_THEME_ID); ?>: <?php echo esc_url(get_the_permalink()); ?></a>
			<ul class="sharebuttons">
				...
				<li><a href="mailto:?body=<?php echo esc_attr(get_the_permalink()); ?>" class="socialdark email"><i class="fa fa-envelope"></i></a></li>
			</ul>
		</div>
	</section>